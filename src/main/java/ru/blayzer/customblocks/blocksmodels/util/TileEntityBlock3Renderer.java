...
public class TileEntityBlock3Renderer extends TileEntitySpecialRenderer {
    
    //Модель для блока
    private final Block3Model model;
    
    public TileEntityBlock3Renderer() {
            this.model = new Block3Model();
    }
