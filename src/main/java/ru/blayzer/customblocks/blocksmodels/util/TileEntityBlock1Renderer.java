...
public class TileEntityBlock1Renderer extends TileEntitySpecialRenderer {
    
    //Модель для блока
    private final Block1Model model;
    
    public TileEntityBlock1Renderer() {
            this.model = new Block1Model();
    }
